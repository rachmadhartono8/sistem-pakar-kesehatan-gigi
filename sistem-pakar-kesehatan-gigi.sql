...
--
-- Table structure for table `tb_simpan_data`
--

DROP TABLE IF EXISTS `tb_simpan_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_simpan_data` (
...
--
-- Dumping data for table `tb_simpan_data`
--

LOCK TABLES `tb_simpan_data` WRITE;
/*!40000 ALTER TABLE `tb_simpan_data` DISABLE KEYS */;
INSERT INTO `tb_simpan_data` VALUES ('mn ',1,'1','1'),('12',12,'12','12'),('nefri',1,'1','Yogya'),('Rachmad Hartono',12,'12','12');
/*!40000 ALTER TABLE `tb_simpan_data` ENABLE KEYS */;
UNLOCK TABLES;
